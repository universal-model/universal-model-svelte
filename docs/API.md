...
return reactive sub-state(s) for Svelte component with given id and given sub-state(s)
...
return reactive selectors for Svelte component with given id and given selectors
